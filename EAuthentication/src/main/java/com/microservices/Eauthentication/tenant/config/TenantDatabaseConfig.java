...
@ComponentScan(basePackages = { "com.microservices.Eauthentication.tenant.repository",
        "com.microservices.Eauthentication.tenant.model" })
@EnableJpaRepositories(basePackages = {
        "com.microservices.Eauthentication.tenant.repository",
        "com.microservices.Eauthentication.tenant.service" }, 
